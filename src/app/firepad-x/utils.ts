...
class ValidationError extends Error {
  override readonly name: string = "Validation Failed";
}
...
class NoopError extends Error {
  override readonly name: string = "No-op Encountered";
}
...
class InvalidOperationError extends Error {
  override readonly name: string = "Invalid Operation Encountered";
}
...
class InvalidOperationOrderError extends Error {
  override readonly name: string = "Invalid Order of Operations Encountered";
}
...
class InvalidEventError extends Error {
  override readonly name: string = "Invalid Event Encountered";
}
...
class DatabaseTransactionError extends Error {
  override readonly name: string = "Transaction Failed";
}
